...
Build and upload commands live in the [mod template](https://sandustry-modding.github.io/SandustryModTemplate/#/docs/builds.md).
...
Full SteamCMD setup, credentials, and flags: [Builds guide](https://sandustry-modding.github.io/SandustryModTemplate/#/docs/builds.md).
