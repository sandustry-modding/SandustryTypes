...
The [mod template](https://sandustry-modding.github.io/SandustryModTemplate/#/docs/modinfo.md) documents `defineModInfo`, `modinfo.ts` patch exports, and config schema UI.
