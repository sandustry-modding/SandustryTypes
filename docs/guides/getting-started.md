...
- Node 24 if you use the [mod template](https://sandustry-modding.github.io/SandustryModTemplate/#/) for TypeScript builds.
...
The community [mod template](https://sandustry-modding.github.io/SandustryModTemplate/#/) compiles `main.ts` to `main.js` and copies the bundle into the game mods folder.
