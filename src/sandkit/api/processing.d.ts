...
export namespace processing {
  ...
  export type WeightedRecipeOutput = {
  ...
  export type PlanterBoxRecipeDefinitionV1 = {
  ...
  export type ShakerRecipeDefinitionV1 = {
  ...
  export type KineticPressRecipeDefinitionV1 = {
