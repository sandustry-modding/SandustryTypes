 ...
 *
 * @module
 * @see https://sandustry.com/sandkit.html#mod-manifest-heading Official Sandkit API — Mod manifest
 */
...
export interface ConfigSchemaNumber {
   ...
   *
   * @see https://sandustry.com/sandkit.html#mod-manifest-heading Official Sandkit API — Mod manifest `configSchema`
   */
  type: "number";
  /**
 ...
 *
 * @see https://sandustry.com/sandkit.html#mod-manifest-heading Official Sandkit API — Mod manifest `textureOverrides`
 */
 ...
 *
 * @see https://sandustry.com/sandkit.html#mod-manifest-heading Official Sandkit API — Mod manifest `provides`
 */
 ...
 *
 * @see https://sandustry.com/sandkit.html#mod-manifest-heading Official Sandkit API — Mod manifest `map.blueprints`
 */
 ...
 *
 * @see https://sandustry.com/sandkit.html#mod-manifest-heading Official Sandkit API — Mod manifest `map`
 */
 ...
 *
 * @see https://sandustry.com/sandkit.html#mod-manifest-heading Official Sandkit API — Mod manifest `map.topBounds`
 */
 ...
 *
 * @see https://sandustry.com/sandkit.html#mod-manifest-heading Official Sandkit API — Mod manifest `map.depthLight`
 */
 ...
 *
 * @see https://sandustry.com/sandkit.html#mod-manifest-heading Official Sandkit API — Mod manifest `map.parallax`
 */
 ...
 *
 * @see https://sandustry.com/sandkit.html#mod-manifest-heading Official Sandkit API — Mod manifest `map.colorMappings`
 */
 ...
 *
 * @see https://sandustry.com/sandkit.html#mod-manifest-heading Official Sandkit API — Mod manifest `gameVersion`
 */
...
export interface ModInfo {
   ...
   *
   * @see https://sandustry.com/sandkit.html#mod-manifest-heading Official Sandkit API — Mod manifest `configOverrides`
   */
  configOverrides?: Record<string, string>;
  /**
   * Paths to GLSL shader replacements keyed by shader id (for example `"sky"`).
   *
   * @see https://sandustry.com/sandkit.html#mod-manifest-heading Official Sandkit API — Mod manifest `shaderOverrides`
   */
